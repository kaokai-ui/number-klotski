...
export const hakoiriLevels: KlotskiLevel[] = [
  {
    ...
    pieces: [
      ...
      { id: "ani", role: "wide", label: "兄", x: 1, y: 2, w: 2, h: 1 },
      { id: "ane", role: "soldier", label: "姊", x: 1, y: 3, w: 1, h: 1 },
      { id: "otouto", role: "soldier", label: "弟", x: 2, y: 3, w: 1, h: 1 },
      { id: "imouto-1", role: "soldier", label: "妹", x: 0, y: 4, w: 1, h: 1 },
      { id: "imouto-2", role: "soldier", label: "妹", x: 3, y: 4, w: 1, h: 1 },
    ],
  },
];
